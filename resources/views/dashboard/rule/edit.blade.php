            ...
            <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    <div class="app-card-header px-4 py-3">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-12 col-lg-auto text-center text-lg-start">
                                ...
                                <h4 class="notification-title mb-1">Formulir Ubah Peraturan</h4>
                    ...
                    <div class="app-card-body p-4">
                        <form class="row g-2" method="post" action="/dashboard/rule/{{ $rule->id }}">
                            @method('put')
                            @csrf
                            <div class="col-md-6 position-relative">
                                ...
                                <input type="text" id="validationCustom01" class="form-control" name="pelanggaran"
                                    value="{{ old('pelanggaran', $rule->pelanggaran) }}" placeholder="Isi Nama Pelanggaran"
                                    required>
                            </div>
                            <div class="col-md-6 position-relative">
                                <label for="validationCustom01" class="form-label">Point<span
                                        class="text-danger">*</span></label>
                                <input type="number" id="validationCustom01" class="form-control" name="point"
                                    value="{{ old('point', $rule->point) }}" required>
                            </div>
                            <div class="col-md-12 position-relative">
                                ...
                                <textarea id="pelanggaran" class="form-control" name="sanksi" placeholder="Masukkan bentuk sanksi..."
                                    style="height: 100px" required>{{ old('sanksi', $rule->sanksi) }}</textarea>
                            </div>
                            <p>
