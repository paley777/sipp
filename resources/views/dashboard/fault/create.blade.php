                    ...
                    <div class="app-card-body p-4">
                        <form class="row g-2" method="post" action="/dashboard/fault">
                            ...
                            <div class="col-md-12 position-relative">
                                <label for="studentSelect" class="form-label">Siswa<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12 position-relative">
                                <label for="validationCustom01" class="form-label">Bentuk Pelanggaran<span
                                        class="text-danger">*</span></label>
                                <textarea id="pelanggaran" class="form-control" name="pelanggaran" placeholder="Masukkan pelanggaran..." style="height: 100px"
                                    required></textarea>
                            </div>
