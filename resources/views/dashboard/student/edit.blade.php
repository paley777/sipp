            ...
            <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    <div class="app-card-header px-4 py-3">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-12 col-lg-auto text-center text-lg-start">
                                ...
                                <h4 class="notification-title mb-1">Formulir Ubah Siswa</h4>
                    ...
                    <div class="app-card-body p-4">
                        <form class="row g-2" method="post" action="/dashboard/student/{{ $student->id }}">
                            @method('put')
                            @csrf
                            ...
                            <div class="col-md-6 position-relative">
                                ...
                                <div>
                                    <input type="radio" id="laki-laki" name="jenis_kelamin" value="L" required
                                        @if (old('jenis_kelamin', $student->jenis_kelamin) == 'L') checked @endif>
                                    <label for="laki-laki">Laki-laki</label>
                                </div>
                                <div>
                                    <input type="radio" id="perempuan" name="jenis_kelamin" value="P" required
                                        @if (old('jenis_kelamin', $student->jenis_kelamin) == 'P') checked @endif>
