            ...
            <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    <div class="app-card-header px-4 py-3">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-12 col-lg-auto text-center text-lg-start">
                                ...
                                <h4 class="notification-title mb-1">Formulir Ubah Kelas</h4>
                    ...
                    <div class="app-card-body p-4">
                        <form class="row g-2" method="post" action="/dashboard/class/{{ $class->id }}">
                            @method('put')
                            @csrf
                            <div class="col-md-12 position-relative">
                                ...
                                <input type="text" id="validationCustom01" class="form-control" name="nama"
                                    placeholder="Isi Nama Kelas"  value="{{ old('nama', $class->nama) }}" required>
                            </div>
                            <p>
